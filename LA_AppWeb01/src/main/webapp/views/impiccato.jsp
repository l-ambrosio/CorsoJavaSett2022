    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Gioco dell'Impiccato</h3>
           ...
           <div class="col-md-12">
            ...
            <div id="alert_perso" class="alert alert-danger" role="alert">Hai Perso !</div>
             ...
             <div class="row">
                  <div class="col-md-4"></div>
                  <div class="col-md-4">
                      <i id="v1" class="fa-solid fa-shield" style="font-size:2em;"></i>
                      <i id="v2" class="fa-solid fa-shield" style="font-size:2em;"></i>
                      <i id="v3" class="fa-solid fa-shield" style="font-size:2em;"></i>
                      <i id="v4" class="fa-solid fa-shield" style="font-size:2em;"></i>
                      <i id="v5" class="fa-solid fa-shield" style="font-size:2em;"></i>
                      <i id="v6" class="fa-solid fa-shield" style="font-size:2em;"></i>
                  </div>
                  <div class="col-md-4"></div>
             </div>
